...
#
# In the DocTamper training flow it is called as:
...
#   the DocTamper configs set decode_head.loss_decode = [CrossEntropy, Lovasz], i.e. the
...
class SegformerHead(BaseDecodeHead):
    ...
    In the DocTamper / TAFE-Net training flow it consumes the four DFDE-refined pyramid
