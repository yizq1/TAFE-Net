_base_ = [
    '../_base_/datasets/rtm_crop_doctamper.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        backbone_extra=dict(
            ...
            init_cfg=dict(type='Pretrained', checkpoint='mit_b2_20220624-66e8bf70.pth'),
            in_channels=3,
            embed_dims=64,
            modals=['img','img1'],
            in_modals=(2,2,2,2),
...
train_pipeline = [
    dict(type='LoadImageLabelFromFileLMDB',
         file_client_args={
             'db_path':'/data3/yzq/data/DocTamperV1/DocTamperV1-TrainingSet'}),
...
test_pipeline = [
    dict(type='LoadImageLabelFromFileLMDB',
        file_client_args={
            'db_path':'/data3/yzq/data/DocTamperV1/DocTamperV1-FCD'}),
    # dict(type='LoadAnnotations', binary=True),
    # dict(type='Resize', scale=(512, 512), keep_ratio=True),
    # dict(type='RandomJpegCompressAndLoadInfo', load_info=True, return_rgb=True, ),
    # dict(type='BioMedicalGaussianNoise', prob=1,std=3),
    dict(type='RandomJpegCompressAndLoadInfo', load_info=True, return_rgb=True,
    compress_pk='/data3/yzq/code/RTM-shuang-2/pks/DocTamperV1-FCD_75.pk'),
    dict(type='PackSegInputsWithExtra', extra_keys=('dct'))
]
...
#     dict(type='LoadImageLabelFromFileLMDB',
#         file_client_args={
#             'db_path':'/data3/yzq/data/DocTamperV1/DocTamperV1-SCD'}),
#     # dict(type='LoadAnnotations', binary=True),
#     # dict(type='Resize', scale=(512, 512), keep_ratio=True),
#     # dict(type='RandomJpegCompressAndLoadInfo', load_info=True, return_rgb=True, ),
#     # dict(type='BioMedicalGaussianNoise', prob=1,std=3),
#     dict(type='RandomJpegCompressAndLoadInfo', load_info=True, return_rgb=True,
#     compress_pk='/data3/yzq/code/RTM-shuang-2/pks/DocTamperV1-SCD_75.pk'),
#     dict(type='PackSegInputsWithExtra', extra_keys=('dct'))
# ]
...
#     dict(type='LoadImageLabelFromFileLMDB',
#         file_client_args={
#             'db_path':'/data3/yzq/data/DocTamperV1/DocTamperV1-TestingSet'}),
#     # dict(type='LoadAnnotations', binary=True),
#     # dict(type='Resize', scale=(512, 512), keep_ratio=True),
#     # dict(type='RandomJpegCompressAndLoadInfo', load_info=True, return_rgb=True, ),
#     # dict(type='BioMedicalGaussianNoise', prob=1,std=3),
#     dict(type='RandomJpegCompressAndLoadInfo', load_info=True, return_rgb=True,
#     compress_pk='/data3/yzq/code/RTM-shuang-2/pks/DocTamperV1-TestingSet_75.pk'),
#     dict(type='PackSegInputsWithExtra', extra_keys=('dct'))
# ]

train_dataloader = dict(batch_size=4, dataset=dict(pipeline=train_pipeline), num_workers=32)
val_dataloader = dict(batch_size=1,dataset=dict(
...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=100000, val_interval=500)
...
load_from= None
work_dir = './work_dirs/tafenet_convnext_doctamper'
