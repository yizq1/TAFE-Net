...
# is wired as model.decode_head in the RTM config tafenet_convnext_rtm.py.
#
...
# convnext RTM config sets loss = L_ce + L_lov (CrossEntropy + Lovasz) with an
...
class FPNHead(BaseDecodeHead):
    ...
    RTM training role: this is the decode head of the ConvNeXt training variant of
