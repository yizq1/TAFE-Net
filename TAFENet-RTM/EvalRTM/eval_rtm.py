...
if __name__ == "__main__":
    ...
    pred_dir='/media/data2/yzq/code/RTM-shuang-2-doctamper/work_dirs/ascformer_rtm_img_img1_highlowdct_convnext_dwtfpn_MultiScaleMultiLowFreqExtractor_doctamper_new_0722/result/pred_mask'
    gt_dir = '/media/data2/yzq/data/RealTextManipulation/masks'
